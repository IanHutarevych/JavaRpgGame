...
public class MON_SkeletonLord extends Entity {
    ...
    public void setDialogue() {
        ...
        dialogues[0][0] = "No one can beat me and steal my treasure";
    ...
    public void checkDrop(){
        ...
        // Restore the previousMusic
        gp.stopMusic();
        gp.playMusic(14);

        // Remove the iron door
        for (int i = 0; i < gp.obj[1].length; i++) {
            if (gp.obj[gp.currentMap][i] != null && gp.obj[gp.currentMap][i].name.equals(OBJ_DoorDungeon.objName)) {
                gp.playSE(3);
